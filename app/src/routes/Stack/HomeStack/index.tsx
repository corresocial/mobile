		...
		<StateProvider>
			<LocationProvider>
				...
				>
					...
					<Stack.Screen
						name={"ViewServicePostHome"}
						component={ViewServicePost}
					/>
					<Stack.Screen
						name={"ViewSalePostHome"}
						component={ViewSalePost}
					/>
					<Stack.Screen
						name={"ViewVacancyPostHome"}
						component={ViewVacancyPost}
					/>
					<Stack.Screen
						name={"ViewSocialImpactPostHome"}
						component={ViewSocialImpactPost}
					/>
					<Stack.Screen
						name={"ViewCulturePostHome"}
