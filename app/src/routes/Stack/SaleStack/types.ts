import { DaysOfWeek, LocationViewType, SaleCategories } from '../../../services/firebase/types'
...
export type SaleStackParamList = {
	...
	InsertSaleLocation: { locationView: LocationViewType, editMode?: boolean, initialValue?: string }
