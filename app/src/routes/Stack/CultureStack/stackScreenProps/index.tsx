...
export type SelectDaysOfWeekScreenProps = NativeStackScreenProps<CultureStackParamList, 'SelectDaysOfWeek'>
export type InsertCultureStartDateScreenProps = NativeStackScreenProps<CultureStackParamList, 'InsertCultureStartDate'>
export type InsertCultureStartHourScreenProps = NativeStackScreenProps<CultureStackParamList, 'InsertCultureStartHour'>
