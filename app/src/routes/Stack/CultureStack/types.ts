...
export type CultureStackParamList = {
	...
	InsertCultureTitle:
		| { editMode: boolean; initialValue: string; cultureType: CultureType }
		| undefined; // cultureType: CultureType is edit auxiliary
	...
	CulturePicturePreview:
		...
		| undefined;
	SelectCultureCategory:
		| { editMode: boolean; cultureType: CultureType }
		| undefined;
	SelectCultureTags: {
		categorySelected: CultureCategories;
		editMode?: boolean;
	};
	...
	SelectCultureLocationView:
		...
		| undefined;
	InsertCultureLocation: {
		locationView: LocationViewType;
		editMode?: boolean;
		initialValue?: LatLong;
	};
	CultureLocationViewPreview: {
		locationView: LocationViewType;
		editMode?: boolean;
	};
