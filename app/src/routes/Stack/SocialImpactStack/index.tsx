...
export function SocialImpactStack() {
	return (
		<SocialImpactProvider>
			...
			>
				<Stack.Screen
					name={"SelectSocialImpactCategory"}
					component={SelectSocialImpactCategory}
				/>
				<Stack.Screen
					name={"SelectSocialImpactTags"}
					component={SelectSocialImpactTags}
				/>
				<Stack.Screen
					name={"InsertSocialImpactTitle"}
					component={InsertSocialImpactTitle}
				/>
				<Stack.Screen
				...
				/>
				<Stack.Screen
					name={"InsertSocialImpactPicture"}
					component={InsertSocialImpactPicture}
				/>
				<Stack.Screen
					name={"SocialImpactPicturePreview"}
					component={SocialImpactPicturePreview}
				/>
				<Stack.Screen
					name={"SelectSocialImpactExhibitionRange"}
					component={SelectSocialImpactExhibitionRange}
				/>
				<Stack.Screen
					name={"InsertSocialImpactLocation"}
					component={InsertSocialImpactLocation}
				/>
				<Stack.Screen
					name={"SelectSocialImpactLocationView"}
					component={SelectSocialImpactLocationView}
				/>
				<Stack.Screen
					name={"SocialImpactLocationViewPreview"}
					component={SocialImpactLocationViewPreview}
				/>
				<Stack.Screen
				...
				/>
				<Stack.Screen
					name={"SelectSocialImpactRepeat"}
					component={SelectSocialImpactRepeat}
				/>
			</Stack.Navigator>
		</SocialImpactProvider>
	);
