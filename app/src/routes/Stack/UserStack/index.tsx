	...
	return (
		<StateProvider>
			<EditProvider>
				<Stack.Navigator
					initialRouteName={
						tourPerformed ? "HomeTab" : "WelcomeNewUser"
					}
					screenOptions={{
						headerShown: false,
						gestureEnabled: true,
				...
				>
					...
					/>
					<Stack.Screen
						name={"SocialImpactStack"}
						component={SocialImpactStack}
					/>
					<Stack.Screen
						name={"EditProfile"}
					...
					<Stack.Screen
						...
						component={EditServicePost}
					/>
					<Stack.Screen
						name={"EditSalePost"}
						component={EditSalePost}
					/>
					<Stack.Screen
						name={"EditVacancyPost"}
						component={EditVacancyPost}
					/>
					<Stack.Screen
						name={"EditSocialImpactPost"}
						component={EditSocialImpactPost}
					/>
					<Stack.Screen
						name={"EditCulturePost"}
						component={EditCulturePost}
					/>
					...
					/>
					<Stack.Screen
						name={"InsertLinkTitle"}
						component={InsertLinkTitle}
					/>
					<Stack.Screen
						name={"InsertLinkValue"}
						component={InsertLinkValue}
					/>
					<Stack.Screen
						name={"Configurations"}
					...
					<Stack.Screen
						name={"WhoWeAreIncome"}
						component={WhoWeAreIncome}
					/>
					<Stack.Screen
						name={"WhoWeAreCulture"}
						component={WhoWeAreCulture}
					/>
					<Stack.Screen
						name={"WhoWeAreTransformation"}
						component={WhoWeAreTransformation}
					/>
					<Stack.Screen name={"HelpUs"} component={HelpUs} />
					<Stack.Screen name={"ContactUs"} component={ContactUs} />
					<Stack.Screen
						name={"ContactUsInsertMessage"}
						component={ContactUsInsertMessage}
					/>
					<Stack.Screen
