...
export function HomeTab({ route, navigation }: HomeTabScreenProps) {
	...
	return (
		<Tab.Navigator
			initialRouteName={
				route.params?.showsInFirstTab ? 'HomeStack' : 'ProfileStack'
			}
			screenOptions={{
