...
function PublicServicesAdButton({ customTitle = '', onPress }: PublicServicesAdButtonProps) {
	...
	return (
		<OptionButton
			...
			labelSize={17}
			relativeHeight={relativeScreenHeight(12)} // SMAS
			shortDescription={'você aí de Londrina, agora você pode consultar seus benefícios sociais!'}
			shortDescriptionHighlightedWords={['Londrina,', 'benefícios', 'sociais']}
