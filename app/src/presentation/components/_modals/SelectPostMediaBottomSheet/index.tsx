...
import { ButtonsContainer, Container, HorizontalListPicturesContainer, PicturePreviewContainer } from './styles'
...
interface SelectPostMediaBottomSheetProps {
	initialValue?: MediaAsset[]
	saveMedia: (picturesUrl: string[], videosUrl: string[]) => void
}

function SelectPostMediaBottomSheet({ initialValue, saveMedia }: SelectPostMediaBottomSheetProps) {
...
export { SelectPostMediaBottomSheet }
