		...
		try {
			const data = [
				...
				},
				{
					...
					questionType: 'select',
					multiSelect: false,
					options: ['Preta', 'Parda', 'Branca', 'Amarelo', 'Indígena', 'Não Sei']
				},
				{
					questionId: '3',
					question: 'Sexo:',
				...
				{
					questionId: '20',
					question: 'Quais aplicativos costuma utilizar mais? (marque todos que se aplicam)',
					questionType: 'select',
					multiSelect: true,
					options: [
						'Tiktok',
			...
			setIsLoading(true)
			await createNewPoll(usePollRepository, { ...newPollDataState, questions: data, owner: pollOwner })
