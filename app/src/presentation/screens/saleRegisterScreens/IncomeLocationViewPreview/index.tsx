...
import { IncomeLocationViewPreviewScreenProps } from '@routes/Stack/IncomeStack/screenProps'
...
function IncomeLocationViewPreview({ route, navigation }: IncomeLocationViewPreviewScreenProps) {
...
export { IncomeLocationViewPreview }
