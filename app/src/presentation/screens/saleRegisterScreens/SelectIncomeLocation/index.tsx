...
import { SelectIncomeLocationScreenProps } from '@routes/Stack/IncomeStack/screenProps'
...
function SelectIncomeLocation({ route, navigation }: SelectIncomeLocationScreenProps) {
	...
	const getInitialMapViewPosition = () => {
		if (incomeDataContext.location) {
			return incomeDataContext.location.coordinates
		}
