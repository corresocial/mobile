...
async function updateChatCompletedStateDM(chatId: Id, currentCompletedState: boolean, recipientUserId?: Id, senderUserName?: string) {
...
export { updateChatCompletedStateDM }
