...
async function phoneVerificationCodeIsValidDM(useAuthenticationService: () => AuthenticationServiceInterface, verificationCodeId: string, verificationCode: string) {
