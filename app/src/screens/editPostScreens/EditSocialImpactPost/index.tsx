...
function EditSocialImpactPost({
	route,
	navigation,
}: EditSocialImpactPostScreenProps) {
	...
	const navigateToEditScreen = (
		screenName: keyof SocialImpactStackParamList,
		initialValue: keyof SocialImpactCollectionRemote,
		...
		<Container>
			...
			<Body>
				...
				<EditCard
					...
					onEdit={() =>
						navigateToEditScreen("InsertSocialImpactTitle", "title")
					}
				/>
				<Sigh />
				<EditCard
				...
				<EditCard
					...
					onEdit={() =>
						navigateToEditScreen(
							"SelectSocialImpactExhibitionRange",
							"range"
						)
					}
				/>
