...
function EditCulturePost({ route, navigation }: EditCulturePostScreenProps) {
	...
	const renderCultureRepeat = () => {
		const socialImpactRepeat = getPostField(
			"eventRepeat"
		) as EventRepeatType;
	...
	const navigateToEditScreen = (
		screenName: keyof CultureStackParamList,
		initialValue: keyof CultureCollectionRemote,
	...
	const editPost = async () => {
		...
		try {
			...
			await updateDocField("users", postData.owner.userId, "posts", [
				postDataToSave,
		...
		<Container>
			...
			<Body>
				<EditCard
					...
					onEdit={() =>
						navigateToEditScreen("SelectCultureCategory", "tags")
					}
				/>
				<Sigh />
				<EditCard
					...
					onEdit={() =>
						navigateToEditScreen("InsertCultureTitle", "title")
					}
				/>
				<Sigh />
				<EditCard
				...
				{postData.cultureType === "eventPost" && (
					<>
						...
						<EditCard
							...
							value={
								formatDate(getPostField("eventStartDate")) ||
								"---"
							}
							onEdit={() =>
								navigateToEditScreen(
									"InsertEventStartDate",
									"eventStartDate"
								)
							}
						/>
						...
						<EditCard
							...
							highlightedWords={["início"]}
							value={
								formatHour(getPostField("eventStartHour")) ||
								"---"
							}
							onEdit={() =>
								navigateToEditScreen(
									"InsertEventStartHour",
									"eventStartHour"
								)
							}
						/>
						...
						<EditCard
							...
							value={
								formatDate(getPostField("eventEndDate")) ||
								"---"
							}
							onEdit={() =>
								navigateToEditScreen(
						...
						<EditCard
							...
							highlightedWords={["fim"]}
							value={
								formatHour(getPostField("eventEndHour")) ||
								"---"
							}
							onEdit={() =>
								navigateToEditScreen(
