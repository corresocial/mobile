...
function EditSalePost({ route, navigation }: EditSalePostScreenProps) {
	...
	const navigateToEditScreen = (
		screenName: keyof SaleStackParamList,
		initialValue: keyof SaleCollectionRemote,
		...
		<Container>
			...
			<Body>
				<EditCard
					...
					onEdit={() =>
						navigateToEditScreen("SelectSaleCategory", "tags")
					}
				/>
				<Sigh />
				<EditCard
					...
					onEdit={() =>
						navigateToEditScreen("InsertSaleTitle", "title")
					}
				/>
				<Sigh />
				<EditCard
