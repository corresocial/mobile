		...
		<Container>
			...
			<Body>
				<DefaultCardContainer flex={1}>
					...
					<TextMedium>{'o 1% mais rico tem quase 50% da riqueza brasileira'}</TextMedium>
					<DescriptionWithLeftTracing
						text={'por meio de um marketplace similar ao ifood/amazon/uber/linkedin, você e outras pessoas podem vender, comprar e encontrar vagas de tudo que é tipo de trabalho.'}
					/>
					<TextMedium>{'quando você faz isso, uma parte do dinheiro é usado em iniciativas sociais nas periferias.'}</TextMedium>
					<Sigh />
