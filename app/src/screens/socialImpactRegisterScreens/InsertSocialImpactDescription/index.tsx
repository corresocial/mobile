...
function InsertSocialImpactDescription({
	...
	const [socialImpactDescription, setSocialImpactDescription] =
		useState<string>(route.params?.initialValue || "");
	const [socialImpactDescriptionIsValid, setSocialImpactDescriptionIsValid] =
			...
			>
				<LineInput
					...
					validateText={(text: string) =>
						validateSocialImpactDescription(text)
					}
					onChangeText={(text: string) =>
						setSocialImpactDescription(text)
					}
				/>
				<ButtonsContainer>
					{socialImpactDescriptionIsValid && !keyboardOpened && (
