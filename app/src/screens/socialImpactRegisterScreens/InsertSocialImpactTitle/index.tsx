...
function InsertSocialImpactTitle({
	route,
	navigation,
}: InsertSocialImpactTitleScreenProps) {
	...
	const [socialImpactTitleIsValid, setSocialImpactTitleIsValid] =
			...
			>
				<LineInput
					...
					validateText={(text: string) =>
						validateSocialImpactTitle(text)
					}
