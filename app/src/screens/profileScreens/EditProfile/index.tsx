...
function EditProfile({ navigation }: EditProfileScreenProps) {
	const { userDataContext, setUserDataOnContext, setDataOnSecureStore } =
	...
	const getProfilePictureUrl = () => {
		if (
			...
			!editDataContext.unsaved.profilePictureUrl
		)
			return "";
		if (
			arrayIsEmpty([editDataContext.unsaved.profilePictureUrl]) &&
			arrayIsEmpty(userDataContext.profilePictureUrl)
		)
			return "";
		return (
			editDataContext.unsaved.profilePictureUrl ||
			...
			<Body style={{ backgroundColor: animateDefaultHeaderBackgound() }}>
				<ScrollView showsVerticalScrollIndicator={false}>
					...
					<EditCard
						...
						value={
							editDataContext.unsaved.name || userDataContext.name
						}
					...
					<EditCard
						...
						value={
							editDataContext.unsaved.description ||
							userDataContext.description
						}
