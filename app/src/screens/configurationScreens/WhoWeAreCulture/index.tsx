		...
		<Container>
			...
			<Body>
				<DefaultCardContainer flex={1}>
					...
					<TextMedium>
						{"conteúdo de qualidade e valor para todos!"}
					</TextMedium>
					<DescriptionWithLeftTracing
						text={
							"aqui temos cursos, séries, leituras, galerias de arte e eventos, tudo escolhido a dedo por pessoas apaixonadas pela arte brasileira"
						}
					/>
					<TextMedium>
						{
				...
				<ButtonContainer>
					<PrimaryButton
						...
						fontSize={20}
						onPress={() =>
							navigation.navigate("WhoWeAreTransformation")
						}
					/>
				</ButtonContainer>
			</Body>
