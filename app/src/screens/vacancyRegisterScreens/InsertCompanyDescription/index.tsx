...
function InsertCompanyDescription({
	route,
	navigation,
}: InsertCompanyDescriptionScreenProps) {
	...
	const [companyDescriptionIsValid, setCompanyDescriptionIsValid] =
		...
		<Container behavior={Platform.OS === "ios" ? "padding" : "height"}>
			...
			>
				<LineInput
					...
					fontSize={16}
					placeholder={
						"ex: simples descrição da empresa, há quanto tempo ela existe, area de atuação, etc..."
					}
					keyboardType={"default"}
					textIsValid={companyDescriptionIsValid && !keyboardOpened}
					validateText={(text: string) =>
						validateCompanyDescription(text)
					}
