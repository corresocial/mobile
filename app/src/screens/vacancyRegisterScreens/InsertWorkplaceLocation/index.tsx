...
function InsertWorkplaceLocation({
	route,
	navigation,
}: InsertWorkplaceLocationScreenProps) {
	...
	return (
		<Container behavior={Platform.OS === "ios" ? "padding" : "height"}>
			<StatusBar
				backgroundColor={
					someInvalidFieldSubimitted() ? theme.red2 : theme.yellow2
				}
			...
			<LineInput
				...
				defaultBackgroundColor={
					validAddress ? theme.yellow1 : theme.white3
				}
				defaultBorderBottomColor={
					validAddress ? theme.yellow5 : theme.black4
				}
