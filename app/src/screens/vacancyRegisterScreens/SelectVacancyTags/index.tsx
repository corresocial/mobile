...
import {
	vacancyCategories,
	updateVacancyTags,
} from "@utils/postsCategories/vacancyCategories";
...
function SelectVacancyTags({
	route,
	navigation,
}: SelectVacancyTagsScreenProps) {
	...
	const renderUnselectedTags = () => {
		const ordenedVacancyTags =
			vacancyCategories[getVacancyCategorySelected()].tags.sort(
				sortArray
			);
	...
	const getCurrentCategoryLabelHightlighted = () => {
		const highlightedWords =
			vacancyCategories[getVacancyCategorySelected()].label.split(" ");
	...
	const getCurrentCategoryLabel = () =>
		vacancyCategories[getVacancyCategorySelected()].label;
	...
	const addNewTag = () => {
		...
		if (
			vacancyCategories[getVacancyCategorySelected()].tags.includes(
			...
			>
				<InputTagArea>
					<LineInput
						...
						textIsValid={vacancyCategories[
							getVacancyCategorySelected()
