...
export function InsertCellNumber({ navigation }: InsertCellNumberScreenProps) {
	...
	const [invalidDDDAfterSubmit, setInvalidDDDAfterSubmit] =
		useState<boolean>(false);
	const [invalidCellNumberAfterSubmit, setInvalidCellNumberAfterSubmit] =
		useState<boolean>(false);
	...
	const someInvalidFieldSubimitted = () =>
		invalidDDDAfterSubmit || invalidCellNumberAfterSubmit;
