...
function InsertCultureDescription({
	route,
	navigation,
}: InsertCultureDescriptionScreenProps) {
	...
	const [cultureDescriptionIsValid, setCultureDescriptionIsValid] =
			...
			>
				<LineInput
					...
					validateText={(text: string) =>
						validateCultureDescription(text)
					}
