...
function CultureLocationViewPreview({
	navigation,
	route,
}: CultureLocationViewPreviewScreenProps) {
			...
			>
				<InfoCard
					...
					description={getLocationViewDescription(
						locationView,
						hasServerSideError,
						"parece que algo deu algo errado do nosso lado, tente novamente em alguns instantantes"
					)}
