...
function SelectServiceFrequency({
	route,
	navigation,
}: SelectServiceFrequencyScreenProps) {
		...
		<Container>
			...
			>
				...
				<InstructionCard
					...
					fontSize={18}
					message={
						"com que frequência você vende/vai vender seu serviço?"
					}
					highlightedWords={[
						"com",
						"que",
			...
			<FormContainer backgroundColor={theme.purple2}>
				<ButtonsContainer>
					<OptionButton
						color={theme.white3}
						label={"só hoje"}
