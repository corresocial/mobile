...
function InsertServicePrestationLocation({
	route,
	navigation,
}: InsertServicePrestationLocationScreenProps) {
	...
	return (
		<Container behavior={Platform.OS === "ios" ? "padding" : "height"}>
			<StatusBar
				backgroundColor={
					someInvalidFieldSubimitted() ? theme.red2 : theme.purple2
				}
			...
			<LineInput
				...
				defaultBackgroundColor={
					validAddress ? theme.purple1 : theme.white3
				}
				defaultBorderBottomColor={
					validAddress ? theme.purple5 : theme.black4
				}
