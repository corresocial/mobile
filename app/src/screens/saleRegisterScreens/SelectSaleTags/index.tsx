...
import {
	saleCategories,
	updateSaleTags,
} from "@utils/postsCategories/saleCategories";
...
function SelectSaleTags({ route, navigation }: SelectSaleTagsScreenProps) {
	...
	const renderUnselectedTags = () => {
		const ordenedSaleTags =
			saleCategories[getSaleCategorySelected()].tags.sort(sortArray);
	...
	const getCurrentCategoryLabelHightlighted = () => {
		const highlightedWords =
			saleCategories[getSaleCategorySelected()].label.split(" ");
		return highlightedWords;
	};

	const getCurrentCategoryLabel = () =>
		saleCategories[getSaleCategorySelected()].label;
	...
	const addNewTag = () => {
		...
		if (
			saleCategories[getSaleCategorySelected()].tags.includes(
			...
			>
				<InputTagArea>
					<LineInput
						...
						textIsValid={saleCategories[
							getSaleCategorySelected()
