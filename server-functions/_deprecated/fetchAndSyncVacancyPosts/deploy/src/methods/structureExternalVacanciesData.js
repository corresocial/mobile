...
exports.structureExternalVacanciesData = void 0;
const ngeohash_1 = require("ngeohash");
const extractDataFromSite_1 = require("./extractDataFromSite");
function structureExternalVacanciesData(externalVacancies) {
    const remoteContact = (0, extractDataFromSite_1.getWhatsAppLink)(externalVacancies); // CURRENT Remove limits
    const vacancies = (0, extractDataFromSite_1.getVacancies)(externalVacancies);
    const coordinates = {
        latitude: -23.309548,
        longitude: -51.162882
    };
...
ATENÇÃO: Uma vez agendado o atendimento por whats, basta estar online no horário escolhido que a secretaria entrará em contato pelo número fornecido no momento do agendamento. não é necessário o comparecimento presencial.`,
            ...
            location: Object.assign({ name: 'Secretaria Municipal do Trabalho, Emprego e Renda', country: 'Brasil', state: 'Paraná', city: 'Londrina', postalCode: '86020-120', district: 'Centro', street: 'R. Pernambuco', number: '162', coordinates: Object.assign({}, coordinates) }, generateGeohashes(coordinates.latitude, coordinates.longitude)),
            owner: {
...
exports.structureExternalVacanciesData = structureExternalVacanciesData;
